...
<table role="presentation" width="100%" style="max-width:840px;margin:0 auto;">
  <tr>
    <td style="background-color:#0f1720;border:1px solid #223148;border-radius:14px;padding:18px 10px;text-align:center;width:19%;">
      <span style="font-size:30px;font-weight:700;color:#22d3ee;font-family:'JetBrains Mono',Consolas,monospace;">6</span><br>
      <span style="font-size:10.5px;color:#6b7f96;letter-spacing:2px;">REPOSITORIES</span>
    </td>
    <td style="width:1%;"></td>
    <td style="background-color:#0f1720;border:1px solid #223148;border-radius:14px;padding:18px 10px;text-align:center;width:19%;">
      <span style="font-size:30px;font-weight:700;color:#7dd3fc;font-family:'JetBrains Mono',Consolas,monospace;">1</span><br>
      <span style="font-size:10.5px;color:#6b7f96;letter-spacing:2px;">STARS</span>
    </td>
    <td style="width:1%;"></td>
    <td style="background-color:#0f1720;border:1px solid #223148;border-radius:14px;padding:18px 10px;text-align:center;width:19%;">
      <span style="font-size:30px;font-weight:700;color:#60a5fa;font-family:'JetBrains Mono',Consolas,monospace;">0</span><br>
      <span style="font-size:10.5px;color:#6b7f96;letter-spacing:2px;">FOLLOWERS</span>
    </td>
    <td style="width:1%;"></td>
    <td style="background-color:#0f1720;border:1px solid #223148;border-radius:14px;padding:18px 10px;text-align:center;width:19%;">
    ...
    <td style="width:1%;"></td>
    <td style="background-color:#0f1720;border:1px solid #223148;border-radius:14px;padding:18px 10px;text-align:center;width:19%;">
      <span style="font-size:30px;font-weight:700;color:#eab308;font-family:'JetBrains Mono',Consolas,monospace;">0</span><br>
      <span style="font-size:10.5px;color:#6b7f96;letter-spacing:2px;">FORKS</span>
    </td>
  </tr>
</table>
<!-- AUTO:STATS_END -->
  ...
  <table role="presentation" width="100%">
    <tr>
      <td style="background-color:#0f1720;border:1px solid #22d3ee;border-radius:14px;padding:20px 20px;">
        <span style="display:inline-block;border-radius:999px;padding:3px 11px;font-size:10px;color:#7dd3fc;letter-spacing:1.5px;font-family:'JetBrains Mono',Consolas,monospace;"><span style="color:#22d3ee;">●</span> FLAGSHIP</span>
        <br><br>
        <span style="font-size:20px;font-weight:700;color:#f1f5f9;">arom-studio</span>
        <br>
        <span style="font-size:12px;color:#7dd3fc;font-family:'JetBrains Mono',Consolas,monospace;">Web design &amp; development agency platform:…</span>
        <br><br>
        <span style="font-size:13px;color:#a3b3c8;line-height:1.6;display:inline-block;">Web design &amp; development agency platform: marketing experience and admin dashboard in React 19 + Vite, backed by an Express 5 API with Prisma + PostgreSQL, Redis caching, S3 / Vercel Blob storage, email automation, JWT auth, document generation, analytics, CI/CD and Docker. Deployed on Vercel.</span>
        <br><br>
        <span style="font-size:11.5px;color:#6b7f96;">TypeScript · JavaScript · HTML · CSS</span>
        <br><br>
        ...
        <br><br>
        <span style="font-size:11px;color:#475569;font-family:'JetBrains Mono',Consolas,monospace;">1 ⭐ · 2026-07-29 · 18.2 MB</span>
      </td>
    </tr>
  </table>
</td>
  ...
  <table role="presentation" width="100%">
    <tr>
      <td style="background-color:#0f1720;border:1px solid #223148;border-radius:14px;padding:20px 20px;">
        <span style="display:inline-block;border-radius:999px;padding:3px 11px;font-size:10px;color:#34d399;letter-spacing:1.5px;font-family:'JetBrains Mono',Consolas,monospace;"><span style="color:#34d399;">●</span> IN DEVELOPMENT</span>
        <br><br>
        <span style="font-size:20px;font-weight:700;color:#f1f5f9;">Share-FIle</span>
        <br>
        <span style="font-size:12px;color:#7dd3fc;font-family:'JetBrains Mono',Consolas,monospace;">Secure file-sharing platform on Next.js 15 +…</span>
        <br><br>
        ...
        <br><br>
        <span style="font-size:11px;color:#475569;font-family:'JetBrains Mono',Consolas,monospace;">2026-06-29 · 66 KB</span>
      </td>
    </tr>
  </table>
</td>
...
<div style="font-size:11px;color:#6b7f96;font-family:'JetBrains Mono',Consolas,monospace;">296 contributions · 2025-08-10 → 2026-08-11</div>
<!-- AUTO:CONTRIB_END --></td>
</tr>
</table>
<br>
